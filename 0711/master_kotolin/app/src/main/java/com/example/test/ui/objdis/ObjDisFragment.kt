...
class ObjDisFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_objdis, container, false)
    }
    ...
    override fun onStart() {
        super.onStart()
        imageView =
            requireActivity().findViewById<View>(R.id.imageView_objdis) as ImageView
        btnChoose =
            requireActivity().findViewById<View>(R.id.button_choose_objdis) as Button
        btnUpload =
            requireActivity().findViewById<View>(R.id.button_upload_objdis) as Button
    ...
    private fun imageUpload(imagePath: String) {
        ...
        val mr = MultipartRequest(
            getString(R.string.BaseUrl) + getString(R.string.ObjDisUrl),
