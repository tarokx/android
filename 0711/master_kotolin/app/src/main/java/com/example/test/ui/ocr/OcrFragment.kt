package com.example.test.ui.ocr
...
class OcrFragment : Fragment() {
    ...
    override fun onStart() {
        super.onStart()
        imageView =
            requireActivity().findViewById<View>(R.id.imageView) as ImageView
        btnChoose =
            requireActivity().findViewById<View>(R.id.button_choose) as Button
        btnUpload =
            requireActivity().findViewById<View>(R.id.button_upload) as Button
    ...
    private fun imageUpload(imagePath: String) {
        ...
        val mr = MultipartRequest(
            getString(R.string.BaseUrl) + getString(R.string.TextUpload),
